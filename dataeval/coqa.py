...
def _generate_config(tokenizer):
    if tokenizer.__class__.__name__ == 'LlamaTokenizer' or tokenizer.__class__.__name__ == 'LlamaTokenizerFast':
        ...
        raise ValueError("tokenizer type is {}".format(tokenizer.__class__.__name__))
