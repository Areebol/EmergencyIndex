...
DATA_SET=HC3
LOG_MODE=offline
SCRIPT=compute_beam_probability.py
...
do 
    ...
    python $SCRIPT --dataset $DATA_SET --wandb_mode $LOG_MODE --max_num_input_tokens $MAX_NUM_INPUT_TOKENS --truncate $TRUNCATE --model_name $MODEL_NAME --model_type $model_type --num_beams $NUM_BEAMS
done
