...
# for ((i=1;i <= 13; i++)) do
# python compute_emergency_index.py --model_name llama_2 --model_type 7b \
...
# for ((i=1;i <= 30; i++)) do
# python compute_emergency_index.py --model_name llama_2 --model_type 13b \
...
# for ((i=1;i <= 26; i++)) do
# python compute_emergency_index.py --model_name qwen_1.5 --model_type 0.5b \
...
# for ((i=1;i <= 25; i++)) do
# python compute_emergency_index.py --model_name qwen_1.5 --model_type 1.8b \
...
for ((i=1;i <= 24; i++)) do
python compute_emergency_index.py --model_name qwen_1.5 --model_type 4b \
...
for ((i=1;i <= 24; i++)) do
python compute_emergency_index.py --model_name qwen_1.5 --model_type 7b \
...
for ((i=1;i <= 24; i++)) do
python compute_emergency_index.py --model_name qwen_1.5 --model_type 14b \
