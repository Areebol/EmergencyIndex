...
# python compute_naive_entropy.py --model_name $MODEL_NAME --wandb_mode online --model_type 72b
# python compute_naive_entropy.py --model_name $MODEL_NAME --wandb_mode online --model_type chat_72b
